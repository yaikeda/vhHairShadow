...
AkgRenderLineOpacityDepth::AkgRenderLineOpacityDepth(void)
{}

AkgRenderLineOpacityDepth::~AkgRenderLineOpacityDepth(void)
{}

void AkgRenderLineOpacityDepth::Render(
  GLuint program,
  ...
  )
{
  if (objectInfo.size() >= 2) {
    std::cout << "LineHairBallのデータを使用します" << std::endl;
  }
...
//protected
void AkgRenderLineOpacityDepth::GetClippingFromLight(
  float nearFar[],
  glm::mat4 modelMtx,
  glm::mat4 viewMtx,
  std::vector<t_ObjectInfo> objectInfo)
