...
AkgRenderOpacityMap::AkgRenderOpacityMap(void)
{}
AkgRenderOpacityMap::~AkgRenderOpacityMap(void)
{}
void AkgRenderOpacityMap::Render(GLuint program, std::vector<t_ObjectInfo> objectInfo, std::vector<t_TextureInfo> texture, float lightMVPMtx[])
{
